...
<head>
    ...
    <script src="{{ asset('js/jquery.min.js') }}" {{--src="js/jquery.min.js"--}}></script>
    <!-- Custom Theme files -->
...
<div class="container">
    ...
    <div class="top-header">
        <div class="logo">
            <a href="index.blade.php"> <img src="images/logo.png" title="barndlogo" /></a>
        </div>
    ...
    <div class="top-header-nav">
        ...
        <nav class="top-nav main-menu">
            <ul class="top-nav">
                <li><a href="list.blade.php"> PRODUCTS </a><span> </span></li>
                <li><a href="products.list">CAMPAINGS</a><span> </span></li>
